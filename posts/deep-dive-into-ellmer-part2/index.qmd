...
As shown in the diagram of ellmer's chat implementation in [Deep Dive into ellmer: Part 1](https://www.howardbaik.com/posts/deep-dive-into-ellmer-part1/#chat-implementation){target="_blank"}, the chat implementation method `$chat_impl()` leads to `$submit_turns()`, which then leads to `chat_perform()`. 
